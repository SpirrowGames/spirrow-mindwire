...
original_stop = stop  # snapshot
# admission-gate 実行、turn.gate_result 更新（省略）
stop = execute_general_decider(turn, cfg, stop=stop, original_stop=original_stop)  # §3.3.a
stop = execute_tierc_decider(turn, cfg, stop=stop, original_stop=original_stop)    # §3.3.b
